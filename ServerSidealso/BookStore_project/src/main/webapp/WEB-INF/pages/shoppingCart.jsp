				...
				<div class="product-preview-container">
					<ul>
						...
						<li>Quantity: <form:input
								path="cartLines[${varStatus.index}].quantity" maxlength="3"/><form:errors path="cartLines[${varStatus.index}].quantity" class="error-message" /></li>
