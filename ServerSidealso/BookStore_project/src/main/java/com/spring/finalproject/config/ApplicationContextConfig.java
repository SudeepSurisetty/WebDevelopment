...
import com.spring.finalproject.impl.OrderDAOImpl;
import com.spring.finalproject.impl.ProductDAOImpl;
import com.spring.finalproject.view.PdfReportView;
import com.spring.finalproject.view.XlsView;
 
@Configuration
@ComponentScan("com.spring.finalproject.*")
...
public class ApplicationContextConfig {
    ...
    public SessionFactory getSessionFactory(DataSource dataSource) throws Exception {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.spring.finalproject.pojo" });
