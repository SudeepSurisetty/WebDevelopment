...
' - The first player to reach 100 points on GLOBAL score wins the game');
    ...
    //Using prompt to solve challenge 2      
    //limit = prompt('What is the winning score to be set?', '100');
...
document.querySelector('.btn-roll').addEventListener('click', function(){
    ...
    // this is done to avoid selecting the same element over and over again 
